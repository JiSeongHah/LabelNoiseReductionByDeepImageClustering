...
if __name__ == '__main__':
    ...
    theta_stop_threshold = 0.0001
    rl_stop_threshold = 0.01
    test_fle_down_path = './dir_reinforce_new1/test4/'
    trn_fle_down_path ='./dir_reinforce_new1/test4/'
    theta_gpu_num = [3]
    model_save_load_path = './dir_reinforce_new1/test4/'

    theta_max_epch = 200
    max_ep = 50
    wayofdata = 'sum'
    noise_ratio = 1
    split_ratio = int(5923*0.08)

    createDirectory('./dir_reinforce_new1/test4/')
