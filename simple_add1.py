...
from excute_simple_rl2 import excute_simple_rl2
...
if __name__ == '__main__':
    ...
    specific_dir_name = mk_name(dir3='/',test='simple_torch2',rwd='minuseachotherVer3',rwd_spread=rwd_spread,reward_normalize=reward_normalize,data_cut_num=data_cut_num,gmma=gamma,num_accmul=iter_to_accumul)
