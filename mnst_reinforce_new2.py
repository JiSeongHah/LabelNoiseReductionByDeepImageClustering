...
if __name__ == '__main__':
    ...
    reward_method = 'last'
    rl_b_size = int(split_ratio)
    WINDOW = 20

    beta4f1Lst = [ 10, 100, 1000, 10000]
    INNER_MAX_STEP_Lst = [64,128,256,512,1024]
    reward_method = 'last'

    for beta4f1 in beta4f1Lst:
        for INNER_MAX_STEP in INNER_MAX_STEP_Lst:
            specific_dir_name = mk_name(dir6='/',innerNum=INNER_MAX_STEP,noise_ratio=noise_ratio,split_ratio=split_ratio,beta=beta4f1)
